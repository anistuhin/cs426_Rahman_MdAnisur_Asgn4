...
public class PlayerMovement : NetworkBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // Stop forward movement when the W key is released
            rb.velocity = new Vector3(0, rb.velocity.y, 0); // This retains any vertical movement, e.g., from jumping or falling
        }
        ...
        {
            // Stop backward movement when the S key is released
            rb.velocity = new Vector3(0, rb.velocity.y, 0); // This retains any vertical movement
        }
